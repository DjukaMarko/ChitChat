      ...
      >
        <motion.div variants={childVariants} className="flex justify-center flex-col space-y-6 md:flex-row items-center">
          ...
          <div className="flex max-w-[70ch] md:ml-36">
            ...
            <div className="w-[30px] bg-gradient-to-b from-[#991b1b] to-[#b91c1c] ml-4"></div>
          </div>
        </motion.div>
        ...
        <motion.button
          ...
          whileTap={{ scale: 1.1 }}
          className="flex mb-10 items-center space-x-4 py-3 px-6 mt-10 w-full justify-center md:w-auto md:justify-start rounded-3xl bg-gradient-to-r from-[#991b1b] to-[#b91c1c]"
        >
